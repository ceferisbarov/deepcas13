...
from deepcas13 import seq_one_hot_code, fold_one_hot_code, get_fold
...
df_train = read_training_data("data/training_data_jingyi.csv")
...
for k in range(5):
    ...
    lst_model[0].evaluate([X_train_seq_CNN, X_train_fold_CNN], y_train)
    break
